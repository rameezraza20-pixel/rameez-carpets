...
const productDatabase: any = {
  ...
  "vip-runner": { category: "VIP Flooring", title: "VIP Runner", description: "Exclusive, high-end runners for red carpet events and VIP arrivals.", image: "/vip-hero.webp", features: ["Premium Texture", "Luxury Aesthetic", "Durable Weave", "Custom Lengths"], gallery: ["/v1.webp", "/v2.webp", "/v3.webp", "/v4.webp"] },
  "grass-carpet": { category: "Outdoor", title: "Grass Carpet", description: "Artificial turf that brings a lush, green aesthetic to any outdoor event.", image: "/grass-hero.webp", features: ["UV Resistant", "Low Maintenance", "Natural Look", "Weather Proof"], gallery: ["/g1.webp", "/g2.webp", "/g3.webp", "/g4.webp"] },
  "vinyl-flooring": { category: "Flooring", title: "Vinyl Flooring", description: "Commercial-grade vinyl that combines style with extreme durability.", image: "/vinyl-hero.webp", features: ["Waterproof", "Easy Clean", "Anti-Scratch", "Modern Finishes"], gallery: ["/vi1.webp", "/vi2.webp", "/vi3.webp", "/vi4.webp"] },
  "rugs": { category: "Rugs", title: "Luxury Rugs", description: "Hand-picked, custom-designed rugs for interior design and commercial spaces.", image: "/rugs-hero.webp", features: ["Soft Touch", "Custom Shapes", "Stain Resistant", "Artisan Quality"], gallery: ["/r1.webp", "/r2.webp", "/r3.webp", "/r4.webp"] },
  "spc-flooring": { category: "Flooring", title: "SPC Flooring", description: "State-of-the-art stone plastic composite flooring for modern interiors.", image: "/spc-hero.webp", features: ["Rigid Core", "Impact Resistant", "Sound Proof", "Fast Click Install"], gallery: ["/s1.webp", "/s2.webp", "/s3.webp", "/s4.webp"] },
  "tile-carpet": { category: "Flooring", title: "Tile Carpet", description: "Modular carpet tiles designed for flexibility in office and commercial spaces.", image: "/tile-hero.webp", features: ["Easy Replacement", "Sound Proof", "Modular Design", "Heavy Duty"], gallery: ["/t1.webp", "/t2.webp", "/t3.webp", "/t4.webp"] },
  "design-carpet": { category: "Custom", title: "Design Carpet", description: "Bespoke carpet designs tailored to your corporate or brand identity.", image: "/design-hero.webp", features: ["Unlimited Patterns", "Commercial Grade", "High-Definition Print", "Brand Specific"], gallery: ["/d1.webp", "/d2.webp", "/d3.webp", "/d4.webp"] },
  "mosque-carpet": { category: "Specialized", title: "Mosque Carpet", description: "Soft, high-quality prayer carpets designed for comfort and durability.", image: "/mosque-hero.webp", features: ["Antimicrobial", "Comfort Cushion", "Easy Maintenance", "Traditional Designs"], gallery: ["/m1.webp", "/m2.webp", "/m3.webp", "/m4.webp"] }
};
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gray-100 py-8 px-6">
        <div className="container mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-[10px] uppercase font-bold text-gray-600">
          {[ { icon: <ShieldCheck className="text-red-600"/>, text: "Certified Quality" }, { icon: <Truck className="text-red-600"/>, text: "Fast GCC Shipping" }, { icon: <Users className="text-red-600"/>, text: "Corporate Trusted" }, { icon: <CheckCircle className="text-red-600"/>, text: "Expert Installation" } ].map((item, i) => (
      ...
      <section className="py-12 text-center bg-gray-50 border-b">
        <button onClick={() => setIsModalOpen(true)} className="bg-red-700 text-white px-10 py-4 rounded font-bold hover:bg-red-800 transition uppercase tracking-widest">
          Download Catalogue
        </button>
      </section>
              ...
              <form 
                onSubmit={async (e) => {
                  ...
                  const res = await fetch('/api/send-lead', {
                    ...
                    body: JSON.stringify({ ...data, formName: `Catalog Download: ${product.title}` }),
                  });
